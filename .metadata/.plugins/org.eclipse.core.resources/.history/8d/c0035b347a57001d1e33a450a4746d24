...
/* Definitions for DateAndTime */
osThreadId_t DateAndTimeHandle;
const osThreadAttr_t DateAndTime_attributes = {
  .name = "DateAndTime",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityRealtime7,
};
/* Definitions for WifiControlsign */
osThreadId_t WifiControlsignHandle;
const osThreadAttr_t WifiControlsign_attributes = {
  .name = "WifiControlsign",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for LightsFollowAlo */
osThreadId_t LightsFollowAloHandle;
const osThreadAttr_t LightsFollowAlo_attributes = {
  .name = "LightsFollowAlo",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* USER CODE BEGIN PV */
...
/**
  * @brief  Function implementing the DateAndTime thread.
...
/**
* @brief Function implementing the WifiControlsign thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the LightsFollowAlo thread.
* @param argument: Not used
* @retval None
*/
